...
if(isset($_POST['url'])){
    $client = new YLink("DefaultPasswords");
    try{
...
?>
            				<form class="form-shorten" method="post">
            					...
            					<div class="row">
                					<div class="form-label-group col-md-4">
                						<button class="btn btn-outline-info" type="button" aria-controls="customLink" data-toggle="collapse" data-target="#customLink" aria-expanded="false">Custom link</button>
                					</div>
        ...
        <footer class="font-small fixed-bottom">
            <div class="text-center py-3 text-light">
                &copy; 2018-2020 <a href="https://y-link.ml/admin" target="_blank" class="text-light"><u>Yehuda Eisenberg</u></a>
            </div>
        </footer>
    </body>
</html>